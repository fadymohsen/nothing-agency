  ...
  return (
    <header className={headerClasses}>
      <div className="relative w-[calc(100%-30px)] ml-[15px] md:w-[calc(100%-100px)] md:ml-[50px]">
        <div className="absolute left-0 top-[45px] md:top-[22px] block cursor-pointer">
        ...
        <div className="relative inline-block float-right pt-[10px] mt-[43px] md:mt-[26px] md:pl-[15px] md:pt-[15px] transition-all duration-300 ease-out">
          <div
